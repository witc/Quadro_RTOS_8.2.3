...
//#include "FreeRTOS_V_8_Header.h"
   //
//#define i2c_write   MPU_9150_send
//#define i2c_read    MPU_9150_read 
...
//
    //if (st.chip_cfg.dmp_on) {
        ...
        //else
            //tmp = 0x00;
        //if (MPU_9150_send( st.reg->int_enable, 1, &tmp))
            //return -1;
...
//{
    ...
    //if (reg >= st.hw->num_reg)
        //return -1;
    //return MPU_9150_read( reg, 1, data);
//}
//
///**
...
//
    ///* Reset device. */
    //data[0] = BIT_RESET;
    //if (MPU_9150_send( st.reg->pwr_mgmt_1, 1, data))
        //return -1;
    //delay_ms(100);
//
    ///* Wake up chip. */
...
//#ifdef MPU6500
    ...
    //if (MPU_9150_send( st.reg->accel_cfg2, 1, data))
        //return -1;
//#endif
//
...
//
    //if (!rate) {
        ...
        //tmp[0] = 0;
        //tmp[1] = BIT_STBY_XYZG;
        //if (MPU_9150_send( st.reg->pwr_mgmt_1, 2, tmp))
            //return -1;
        //st.chip_cfg.lp_accel_mode = 0;
        //return 0;
    //}
...
//#elif defined MPU6500
    ...
    //else
        //tmp[0] = INV_LPA_640HZ;
    //if (MPU_9150_send( st.reg->lp_accel_odr, 1, tmp))
        //return -1;
    //tmp[0] = BIT_LPA_CYCLE;
    //if (MPU_9150_send( st.reg->pwr_mgmt_1, 1, tmp))
        //return -1;
//#endif
...
//
    //if (!(st.chip_cfg.sensors & INV_XYZ_GYRO))
        //return -1;
//
    //if (MPU_9150_read( st.reg->raw_gyro, 6, tmp))
        //return -1;
...
//
    //if (!(st.chip_cfg.sensors & INV_XYZ_ACCEL))
        //return -1;
//
    //if (MPU_9150_read( st.reg->raw_accel, 6, tmp))
        //return -1;
    //data[0] = (tmp[0] << 8) | tmp[1];
    //data[1] = (tmp[2] << 8) | tmp[3];
    //data[2] = (tmp[4] << 8) | tmp[5];
...
//
    //if (!(st.chip_cfg.sensors))
        //return -1;
//
    //if (MPU_9150_read( st.reg->temp, 2, tmp))
        //return -1;
    //raw = (tmp[0] << 8) | tmp[1];
    //if (timestamp)
       //
...
//int mpu_read_6500_accel_bias(long *accel_bias) {
	//unsigned char data[6];
	//if (MPU_9150_read( 0x77, 2, &data[0]))
		//return -1;
	//if (MPU_9150_read( 0x7A, 2, &data[2]))
		//return -1;
	//if (MPU_9150_read( 0x7D, 2, &data[4]))
		//return -1;
...
//int mpu_read_6050_accel_bias(long *accel_bias) {
	//unsigned char data[6];
	//if (MPU_9150_read( 0x06, 2, &data[0]))
		//return -1;
	//if (MPU_9150_read( 0x08, 2, &data[2]))
		//return -1;
	//if (MPU_9150_read( 0x0A, 2, &data[4]))
		//return -1;
	//accel_bias[0] = ((long)data[0]<<8) | data[1];
	//accel_bias[1] = ((long)data[2]<<8) | data[3];
	//accel_bias[2] = ((long)data[4]<<8) | data[5];
...
//int mpu_read_6500_gyro_bias(long *gyro_bias) {
	//unsigned char data[6];
	//if (MPU_9150_read( 0x13, 2, &data[0]))
		//return -1;
	//if (MPU_9150_read( 0x15, 2, &data[2]))
		//return -1;
	//if (MPU_9150_read( 0x17, 2, &data[4]))
		//return -1;
...
//{
    ...
    //if (MPU_9150_send( 0x13, 2, &data[0]))
        //return -1;
    //if (MPU_9150_send( 0x15, 2, &data[2]))
        //return -1;
    //if (MPU_9150_send( 0x17, 2, &data[4]))
        //return -1;
    //return 0;
//}
//
...
//
    //if (MPU_9150_send( 0x06, 2, &data[0]))
        //return -1;
    //if (MPU_9150_send( 0x08, 2, &data[2]))
        //return -1;
    //if (MPU_9150_send( 0x0A, 2, &data[4]))
        //return -1;
//
    //return 0;
//}
...
//
    ...
    //data[5] = (accel_reg_bias[2]) & 0xff;
//
    //if (MPU_9150_send( 0x77, 2, &data[0]))
        //return -1;
    //if (MPU_9150_send( 0x7A, 2, &data[2]))
        //return -1;
    //if (MPU_9150_send( 0x7D, 2, &data[4]))
        //return -1;
//
    //return 0;
//}
...
//
    //data = 0;
    //if (MPU_9150_send( st.reg->int_enable, 1, &data))
        //return -1;
    //if (MPU_9150_send( st.reg->fifo_en, 1, &data))
        //return -1;
    //if (MPU_9150_send( st.reg->user_ctrl, 1, &data))
        //return -1;
//
    //if (st.chip_cfg.dmp_on) {
    ...
    //} else {
        ...
        //if (MPU_9150_send( st.reg->int_enable, 1, &data))
            //return -1;
        //if (MPU_9150_send( st.reg->fifo_en, 1, &st.chip_cfg.fifo_enable))
            //return -1;
    //}
    //return 0;
//}
...
//
    //if (st.chip_cfg.gyro_fsr == (data >> 3))
        //return 0;
    //if (MPU_9150_send( st.reg->gyro_cfg, 1, &data))
        //return -1;
...
//
    //if (st.chip_cfg.accel_fsr == (data >> 3))
        //return 0;
    //if (MPU_9150_send( st.reg->accel_cfg, 1, &data))
        //return -1;
...
//
    //if (st.chip_cfg.lpf == data)
        //return 0;
    //if (MPU_9150_send( st.reg->lpf, 1, &data))
        //return -1;
...
//
        //data = 1000 / rate - 1;
        //if (MPU_9150_send( st.reg->rate_div, 1, &data))
            //return -1;
//
...
//
    ...
    //if (MPU_9150_send( st.reg->s4_ctrl, 1, &div))
        //return -1;
...
//
    ...
    //if (!(sensors & INV_XYZ_ACCEL))
        //data |= BIT_STBY_XYZA;
    //if (MPU_9150_send( st.reg->pwr_mgmt_2, 1, &data)) {
        //st.chip_cfg.sensors = 0;
        //return -1;
    //}
//
...
//#ifdef AK89xx_BYPASS
    ...
    //else
        //mpu_set_bypass(0);
//#else
    //if (MPU_9150_read( st.reg->user_ctrl, 1, &user_ctrl))
        //return -1;
    ...
    //else
        //user_ctrl &= ~BIT_DMP_EN;
    //if (MPU_9150_send( st.reg->s1_do, 1, &data))
        //return -1;
    ///* Enable/disable I2C master mode. */
    //if (MPU_9150_send( st.reg->user_ctrl, 1, &user_ctrl))
        //return -1;
//#endif
//#endif
//
...
//{
    ...
    //if (!st.chip_cfg.sensors)
        //return -1;
    //if (MPU_9150_read( st.reg->dmp_int_status, 2, tmp))
        //return -1;
...
//
    ...
    //if (st.chip_cfg.fifo_enable & INV_XYZ_ACCEL)
        //packet_size += 6;
//
    //if (MPU_9150_read( st.reg->fifo_count_h, 2, data))
        //return -1;
...
////    log_i("FIFO count: %hd\n", fifo_count);
    //if (fifo_count > (st.hw->max_fifo >> 1)) {
        ...
        //if (MPU_9150_read( st.reg->int_status, 1, data))
            //return -1;
  ...
  //
//
    //if (MPU_9150_read( st.reg->fifo_r_w, packet_size, data))
        //return -1;
...
//{
    ...
    //if (!st.chip_cfg.sensors)
        //return -1;
//
    //if (MPU_9150_read( st.reg->fifo_count_h, 2, tmp))
        //return -1;
    ...
    //if (fifo_count > (st.hw->max_fifo >> 1)) {
        ///* FIFO is 50% full, better check overflow bit. */
        //if (MPU_9150_read( st.reg->int_status, 1, tmp))
            //return -1;
    ...
    //}
//
    //if (MPU_9150_read( st.reg->fifo_r_w, length, data))
        //return -1;
...
//
    //if (bypass_on) {
        //if (MPU_9150_read( st.reg->user_ctrl, 1, &tmp))
            //return -1;
        //tmp &= ~BIT_AUX_IF_EN;
        //if (MPU_9150_send( st.reg->user_ctrl, 1, &tmp))
            //return -1;
        //delay_ms(3);
        //tmp = BIT_BYPASS_EN;
        ...
        //if (MPU_9150_send( st.reg->int_pin_cfg, 1, &tmp))
            //return -1;
    //} else {
...
//
    //data[0] = 0x01;
    //data[1] = 0;
    //if (MPU_9150_send( st.reg->pwr_mgmt_1, 2, data))
        //return -1;
    //delay_ms(200);
    //data[0] = 0;
    //if (MPU_9150_send( st.reg->int_enable, 1, data))
    ...
    //if (MPU_9150_send( st.reg->pwr_mgmt_1, 1, data))
        //return -1;
    //if (MPU_9150_send( st.reg->i2c_mst, 1, data))
        //return -1;
    //if (MPU_9150_send( st.reg->user_ctrl, 1, data))
        //return -1;
...
//
    //for (ii = 0; ii < packet_count; ii++) {
        ...
        //if (MPU_9150_read( st.reg->fifo_r_w, MAX_PACKET_LENGTH, data))
            //return -1;
...
//{
    ...
    //if (MPU_9150_read( REG_6500_XA_ST_DATA, 3, regs)) {
    	//if(debug)
    	//
    	//return 0x07;
    //}
...
//{
    ...
    //unsigned char regs[3];
//
    //if (MPU_9150_read( REG_6500_XG_ST_DATA, 3, regs)) {
    	//if(debug)
    		//
        //return 0x07;
    //}
...
//
		...
		//if (MPU_9150_read( st.reg->fifo_r_w, read_size, data))
						//return -1;
		//ind = 0;
		//for (ii = 0; ii < packet_count; ii++) {
			//short accel_cur[3], gyro_cur[3];
...
//
    ...
    //if (tmp[1] + length > st.hw->bank_size)
        //return -1;
//
    //if (MPU_9150_send( st.reg->bank_sel, 2, tmp))
        //return -1;
    //if (MPU_9150_send( st.reg->mem_r_w, length, data))
        //return -1;
    //return 0;
//}
//
...
//
    //if (MPU_9150_send( st.reg->bank_sel, 2, tmp))
        //return -1;
    //if (MPU_9150_read( st.reg->mem_r_w, length, data))
        //return -1;
    //return 0;
//}
//
...
//
    ...
    //if (MPU_9150_send( st.reg->prgm_start_h, 2, tmp))
        //return -1;
//
...
//
    ...
    //if (MPU_9150_send( st.reg->s0_addr, 1, data))
        //return -1;
//
    ///* Compass reads start at this register. */
    //data[0] = AKM_REG_ST1;
    //if (MPU_9150_send( st.reg->s0_reg, 1, data))
        //return -1;
//
    ///* Enable slave 0, 8-byte reads. */
    //data[0] = BIT_SLAVE_EN | 8;
    //if (MPU_9150_send( st.reg->s0_ctrl, 1, data))
        //return -1;
//
    ///* Slave 1 changes AKM measurement mode. */
    //data[0] = st.chip_cfg.compass_addr;
    //if (MPU_9150_send( st.reg->s1_addr, 1, data))
        //return -1;
//
    ///* AKM measurement mode register. */
    //data[0] = AKM_REG_CNTL;
    //if (MPU_9150_send( st.reg->s1_reg, 1, data))
        //return -1;
//
    ///* Enable slave 1, 1-byte writes. */
    //data[0] = BIT_SLAVE_EN | 1;
    //if (MPU_9150_send( st.reg->s1_ctrl, 1, data))
        //return -1;
//
    ///* Set slave 1 data. */
...
//
    ...
    //data[0] = 0x03;
    //if (MPU_9150_send( st.reg->i2c_delay_ctrl, 1, data))
        //return -1;
//
//#ifdef MPU9150
    ///* For the MPU9150, the auxiliary I2C bus needs to be set to VDD. */
    //data[0] = BIT_I2C_MST_VDDIO;
    //if (MPU_9150_send( st.reg->yg_offs_tc, 1, data))
        //return -1;
//#endif
//
    //return 0;
...
//#ifdef AK89xx_BYPASS
    ...
    //if (i2c_write(st.chip_cfg.compass_addr, AKM_REG_CNTL, 1, tmp+8))
        //return -1;
//#else
    //if (MPU_9150_read( st.reg->raw_compass, 8, tmp))
        //return -1;
//#endif
//
//#if defined AK8975_SECONDARY
...
//
        ...
        //if (MPU_9150_send( st.reg->user_ctrl, 3, data))
            //goto lp_int_restore;
//
        ///* Set motion threshold. */
        //data[0] = thresh_hw;
        //if (MPU_9150_send( st.reg->motion_thr, 1, data))
            //goto lp_int_restore;
//
        ///* Set wake frequency. */
        //if (lpa_freq == 1)
        ...
        //if (MPU_9150_send( st.reg->lp_accel_odr, 1, data))
            //goto lp_int_restore;
//
        ///* Enable motion interrupt (MPU6500 version). */
        //data[0] = BITS_WOM_EN;
        //if (MPU_9150_send( st.reg->accel_intel, 1, data))
            //goto lp_int_restore;
//
        ///* Enable cycle mode. */
